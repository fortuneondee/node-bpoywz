...
import { doc, updateDoc, increment, collection, addDoc, serverTimestamp, runTransaction, getDoc } from 'firebase/firestore';
...
export default function BankTransfer() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      toast.error(error.message || 'Failed to process tran